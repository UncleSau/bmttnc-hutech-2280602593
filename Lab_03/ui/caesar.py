...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 240, 71, 16))
        self.label_4.setObjectName("label_4")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(190, 380, 93, 28))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(190, 170, 371, 31))
        self.txt_key.setObjectName("txt_key")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(470, 380, 93, 28))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(190, 230, 381, 121))
        self.textEdit.setObjectName("textEdit")
        self.txt_plain_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(190, 50, 371, 87))
